...
```bash
git clone https://ghfast.top/https://github.com/saladday/labproxy.git
cd labproxy
```
...
# 😼 进程 PID: 276368
# 😼 运行时间: 04:53
# 😼 配置文件: /home/fangjingluo/.labproxy/runtime.yaml
# 😼 日志文件: /home/fangjingluo/.labproxy/logs/labproxy.log
# 😼 代理端口: 54016
# 😼 管理端口: 19090
# 😼 DNS端口: 15353
# 😼 系统代理：开启
...
│   ├── subconverter        # 订阅转换工具
│   ├── yq                  # YAML 处理工具
│   └── labproxy-tui        # 内置 TUI 二进制 (首次使用时本地构建)
├── config/                 # 配置文件
│   ├── config.yaml         # 主配置文件
│   ├── mixin.yaml          # 自定义配置
